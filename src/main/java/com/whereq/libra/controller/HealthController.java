...
public class HealthController {
    ...
    public ResponseEntity<Map<String, Object>> health() {
        ...
        try {
            SparkSession sparkSession = sessionManager.getOrCreateSession("default");
            String sparkVersion = sparkSession.version();
            String sparkAppId = sparkSession.sparkContext().applicationId();

            Map<String, String> sparkInfo = new HashMap<>();
            sparkInfo.put("version", sparkVersion);
            sparkInfo.put("applicationId", sparkAppId);
